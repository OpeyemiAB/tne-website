...
const mockStore = {
  ...
  products: JSON.parse(localStorage.getItem('tne_products') || JSON.stringify([
    ...
    { id: 'prod-4', name: 'Couples bracelet', price: 40000, image: '/couples_watch_2.jpg', images: ['/couples_watch_2.jpg', '/couples_watch_3.jpg', '/couples_watch_4.jpg', '/couples_watch_5.jpg', '/couples_watch_6.jpg', '/couples_watch_7.jpg'], category: 'Etched by TNE', description: 'Matching custom engraved Casio couple wristwatches set available in Silver, Pink, Royal Blue, Emerald Green, and Matte Black dial variants.', customizable: true, inStock: true },
    ...
    { id: 'prod-19', name: 'Tennis bracelet', price: 3800, image: '/tennis_bracelet_1.jpg', images: ['/tennis_bracelet_1.jpg', '/tennis_bracelet_2.jpg', '/tennis_bracelet_3.jpg', '/tennis_bracelet_4.jpg', '/tennis_bracelet_5.jpg'], category: 'Etched by TNE', description: 'Classic sparkling cubic zirconia tennis bracelets available in Crystal Silver, Warm Gold, Baguette Black Gemstone, and Rainbow Multi-Color gemstone display variants.', customizable: false, inStock: true },
    { id: 'prod-20', name: 'Stone bracelet', price: 12000, image: '/stone_bracelet_1.jpg', images: ['/stone_bracelet_1.jpg', '/stone_bracelet_2.jpg'], category: 'Etched by TNE', description: 'Sparkling halo gemstone collar stone bracelet & matching stud earrings set, available in Rose Pink and Rainbow Multicolor crystal gemstone variants.', customizable: false, inStock: true },
    { id: 'prod-21', name: 'Bracelet', price: 8500, image: '/bracelet_stack_1.jpg', images: ['/bracelet_stack_1.jpg', '/bracelet_stack_2.jpg'], category: 'Etched by TNE', description: 'Luxury 5-piece stackable bangle & chain bracelet set (including screw bangle, clover motif chain, double beaded strands, and nail cuff) available in Yellow Gold & Sterling Silver Finish.', customizable: true, inStock: true },
    { id: 'prod-22', name: 'Full set of flower jewelry', price: 15000, image: '/flower_jewelry_1.jpg', images: ['/flower_jewelry_1.jpg', '/flower_jewelry_2.jpg', '/flower_jewelry_3.jpg'], category: 'Etched by TNE', description: 'Enameled floral blossom 5-piece jewelry set (including pendant necklace, cuff bangle, flower bracelet, ring, and stud earrings), available in Pearl White, Ocean Teal Blue, and Cherry Blossom Pink.', customizable: true, inStock: true }
  ])),
