...
export const fullCatalog22Products = [
  { id: 'watch-1', name: 'Customized Watch', price: 27000, image: 'https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1524592094714-0f0654e20314?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Elegant golden mesh watch, custom engraved on caseback.', customizable: true, inStock: true },
  { id: 'necklace-1', name: 'Customized Necklace', price: 17500, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Custom nameplate pendant necklace plated in 18k gold.', customizable: true, inStock: true },
  { id: 'bracelet-1', name: 'Engraved Bracelet', price: 13000, image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Sleek open-cuff gold bracelet.', customizable: true, inStock: true },
  { id: 'box-signature', name: 'Luxury Gift Box', price: 35000, image: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=400&q=80'], category: 'TNE Gift Curation', description: 'Our signature emerald gift box with luxury bow.', customizable: false, inStock: true },
  ...
  { id: 'prod-two', name: 'two', price: 20000, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Custom TNE Item.', customizable: true, inStock: true },
  { id: 'prod-three', name: 'three', price: 25000, image: 'https://images.unsplash.com/photo-1513885535751-8b9238bd475a?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1513885535751-8b9238bd475a?auto=format&fit=crop&w=400&q=80'], category: 'TNE Gift Curation', description: 'TNE Curated Collection.', customizable: false, inStock: true },
  { id: 'prod-starter-box', name: 'Starter Gift Box', price: 10000, image: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=400&q=80'], category: 'TNE Gift Curation', description: 'Essential TNE luxury gift box.', customizable: false, inStock: true },
  { id: 'prod-classic-box', name: 'Classic Luxury Box', price: 25000, image: 'https://images.unsplash.com/photo-1513885535751-8b9238bd475a?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1513885535751-8b9238bd475a?auto=format&fit=crop&w=400&q=80'], category: 'TNE Gift Curation', description: 'Classic luxury gift box.', customizable: false, inStock: true },
  { id: 'perfume-set', name: 'Perfume Set', price: 22000, image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=400&q=80'], category: 'TNE Beauty', description: 'Exquisite dual perfume set.', customizable: false, inStock: true },
  ...
  { id: 'prod-pen-keyring', name: 'Customized Pen & Keyring Set', price: 14000, image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Engraved executive pen and leather keyring.', customizable: true, inStock: true },
  { id: 'prod-wallet', name: 'Custom Leather Wallet', price: 16500, image: 'https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1627123424574-724758594e93?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Handcrafted leather wallet with custom initials.', customizable: true, inStock: true },
  { id: 'prod-candle', name: 'Luxury Scented Candle', price: 12500, image: 'https://images.unsplash.com/photo-1603006905003-be475563bc59?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1603006905003-be475563bc59?auto=format&fit=crop&w=400&q=80'], category: 'TNE Collections', description: 'Hand-poured soy wax glass candle.', customizable: false, inStock: true },
  { id: 'prod-flute', name: 'Engraved Champagne Flute', price: 18000, image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Crystal champagne glass laser engraved with initials.', customizable: true, inStock: true },
  { id: 'prod-wooden-box', name: 'Executive Wooden Gift Box', price: 45000, image: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1549465220-1a8b9238cd48?auto=format&fit=crop&w=400&q=80'], category: 'TNE Gift Curation', description: 'Premium wooden luxury box for VIP gifting.', customizable: false, inStock: true },
  { id: 'prod-ring', name: 'Custom Name Ring', price: 11000, image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=400&q=80'], category: 'Etched by TNE', description: 'Polished gold custom name statement ring.', customizable: true, inStock: true },
  { id: 'prod-deluxe-wine', name: 'Deluxe Chocolate & Wine Curation', price: 38000, image: 'https://images.unsplash.com/photo-1513885535751-8b9238bd475a?auto=format&fit=crop&w=400&q=80', images: ['https://images.unsplash.com/photo-1513885535751-8b9238bd475a?auto=format&fit=crop&w=400&q=80'], category: 'TNE Gift Curation', description: 'Artisanal chocolates and premium wine curation.', customizable: false, inStock: true }
];

export const restoreAllProductsToLive = async () => {
  localStorage.removeItem('tne_dropped_products');
  mockStore.products = [...fullCatalog22Products];
  safeSetLocalStorage('tne_products', JSON.stringify(mockStore.products));
  try {
    await fetch('/api/sync', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ clearDroppedIds: true, products: fullCatalog22Products, overrideProducts: true })
    });
  } catch (e) {}
  if (typeof window !== 'undefined') {
    window.dispatchEvent(new Event('tne_db_update'));
