...
const mockStore = {
  ...
  products: JSON.parse(localStorage.getItem('tne_products') || JSON.stringify([
    ...
    { id: 'prod-2', name: 'Canvas Size 41-45', price: 24500, image: '/canvas_1.jpg', images: ['/canvas_1.jpg', '/canvas_2.jpg', '/canvas_3.jpg', '/canvas_4.jpg', '/canvas_5.jpg'], category: 'TNE Collections', description: 'Luxury designer sneakers collection (Size 41-45) including Nike Air Force 1, Vans Old Skool & Air Jordan.', customizable: false, inStock: true },
    ...
    { id: 'prod-4', name: 'Couples bracelet', price: 40000, image: '/couples_watch_1.jpg', images: ['/couples_watch_1.jpg', '/couples_watch_2.jpg'], category: 'Etched by TNE', description: 'Matching custom engraved Casio couple wristwatches & bracelet set in red luxury presentation box.', customizable: true, inStock: true },
